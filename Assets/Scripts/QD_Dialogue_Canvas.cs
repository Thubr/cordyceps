...
{
    public class QD_Dialogue_Canvas: MonoBehaviour
    {
        ...
        public void UpdateDialogueHandler(QD_DialogueHandler currDialogue)
        {
            handler = currDialogue;
        ...
        private void SetText()
        {
            ...
            {
                speakerName.text = GameManager.Instance.getPlayerInfo().CreatureName;
                GenerateChoices();
            }
        }
